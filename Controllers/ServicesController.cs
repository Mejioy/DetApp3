...
namespace DetApp3.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(DetailingCenterDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Services != null ? 
                          ...
                          Problem("Entity set 'DetailingCenterDBContext.Services'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DetailingCenterDBContext.Services'  is null.");
            }
            var service = await _context.Services.FindAsync(id);
            if (service != null)
            {
